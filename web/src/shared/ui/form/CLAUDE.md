...
- `form-controls.test.tsx` 以真实 invalid/input、select、键盘和点击事件覆盖 Field、Input、NativeSelect、SearchInput、Checkbox/CheckboxRow、Choice/RadioChoice 与 SegmentedControl 的 ARIA/状态合同。
