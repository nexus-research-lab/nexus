...
export const OPERATION_TOOL_PROFILES: Record<string, OperationToolProfile> = {
  ...
  TaskCreate: {
    ...
    kind: "task_delegate",
    surface: "task",
    target_keys: ["subject", "title", "description", "input"],
    evidence_type: "task",
  },
  TaskList: {
    action: "task_progress",
  ...
  TaskUpdate: {
    ...
    kind: "task_progress",
    surface: "task",
    target_keys: ["task_id", "taskId", "subject", "title"],
    evidence_type: "task",
  },
  TaskStop: {
    action: "task_progress",
