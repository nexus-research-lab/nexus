...
export function ProviderUnavailableBanner({ compact = false }: ProviderUnavailableBannerProps) {
  return (
    <div className={cn(compact ? "px-1 pb-1" : "mx-auto w-full max-w-[980px] px-4 pb-2 sm:px-6 xl:px-8")}>
      <div className="flex items-center gap-2 rounded-xl border border-[color:color-mix(in_srgb,var(--warning)_26%,transparent)] bg-[color:color-mix(in_srgb,var(--warning)_10%,transparent)] px-3 py-2 text-xs text-(--warning)">
