...
export function ToolBlockHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "grid min-h-7 min-w-0 grid-cols-[20px_minmax(0,1fr)_auto] items-center gap-1.5 radius-control-sm px-0 py-0.5 text-sm font-normal leading-5 text-(--text-soft) transition-colors",
        canToggle
