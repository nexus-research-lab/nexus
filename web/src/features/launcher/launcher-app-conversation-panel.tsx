...
# -*- coding: utf-8 -*-
# =====================================================
# @File   ：launcher-app-conversation-panel.tsx
# @Date   ：2026-04-13 16:22
# @Author ：leemysw
# 2026-04-13 16:22   Create
# =====================================================
*/
...
export function LauncherAppConversationPanel({
  ...
  useEffect(() => {
    ...
    const sync_to_bottom = () => {
      ...
      // 中文注释：面板刚打开时消息高度还会继续结算，引导期内持续贴底。
    ...
    >
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          >
            <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-foreground/72">
      ...
      <div className="mt-3 min-h-0 flex-1">
        {error ? (
          <div className="mb-3 flex items-start gap-2 rounded-[20px] bg-[rgba(255,243,243,0.74)] px-3 py-2 text-xs leading-5 text-red-900/84 shadow-[inset_0_0_0_1px_rgba(255,120,120,0.14)]">
        ...
        <div
          ref={scroll_ref}
          className="soft-scrollbar h-full min-h-0 min-w-0 overflow-x-hidden overflow-y-auto"
