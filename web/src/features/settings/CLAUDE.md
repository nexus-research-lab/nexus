...
- `general/`、`runtime/`、`computer-use/`、`personal/` 与 `provider-settings/` 各自拥有设置资源和交互；`computer-use/` 只在桌面端展示扩展安装、连接状态和完整 CDP 权限。
...
- 设置分区使用 `WorkspaceContentHeader` 组合唯一标题、说明与页面动作；外层设置导航不得再叠加全宽 Surface Header 或重复分区标题。
