...
- Restored the visible Standalone Goal badge for both unbound and identity-reserved Goals, while keeping the reserved explanation explicit that no WorkGraph exists or is guaranteed to be created.
