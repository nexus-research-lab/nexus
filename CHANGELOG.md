...
- Kept room-visible non-lead collaboration evidence monotonic for the whole durable Room Goal lifecycle, so retargeting or consecutive Lead closure rounds no longer demand another collaborator reply after the same Goal has already involved another member.
