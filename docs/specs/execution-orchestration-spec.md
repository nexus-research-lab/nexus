...
| Round-scoped CLI transport and broker | [`internal/cli/agent/runtime_semantic.go`](../../internal/cli/agent/runtime_semantic.go), [`internal/app/server/runtime_command.go`](../../internal/app/server/runtime_command.go) |
