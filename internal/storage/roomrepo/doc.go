...
//
// 成员清单：
//   - sql.go / sql_load.go / sql_delete.go / sql_draft.go / sql_references.go / sql_participation.go：房间读写、每 Room 唯一 draft 的原子确保与修复、至少保留一条对话的删除计划、持久引用探测、带配置版本和权限世代推进的成员参与闸门与事务执行。
