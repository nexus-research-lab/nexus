...
//
// 成员清单：
//   - reply_preview.go：每 owner/Room 唯一的独立短摘要、完成回复写入、按来源编辑/删除失效与批量查询。
...
// MemberAgents 只用于 Room 读模型；realtime 启动 physical round 时必须从 Agent service 批量重新水合权威 runtime 配置。
//
