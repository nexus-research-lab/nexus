...
//   - configuration_runtime.go / automation_runtime.go：nexuscfg 与 Agent-facing nexus CLI 的 loopback broker、physical-round capability、领域确认与 service 路由；不直接向 runtime 开放数据库。
