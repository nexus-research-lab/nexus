...
//   - *_mcp.go：configuration / manager / automation / authorization / communication / connector / execution / goal / visualize / imagegen / room 内建 MCP server 按 Session 拓扑稳定装配；DM runner / Room slot 逐轮绑定统一动态 Responsibility authority、exact Goal/revision/Execution、trusted WorkBinding/ReviewBinding 与 human authority。
