...
//   - routes.go / routes_web.go / http_handlers.go / websocket.go：HTTP/Web 路由（含密码修改 exact receipt 核对/收口）、HTTP handlerSet 装配、WS 入口与 orchestration ExecutionInvalidationSink 装配。
