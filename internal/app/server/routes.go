...
func (s *Server) mountProviderRoutes() {
	...
	s.router.Delete(s.prefixPath("/settings/providers/{provider}/models/{model_id}"), s.handlers.provider.HandleDeleteProviderModel)
...
func (s *Server) mountAgentRoutes() {
	...
	s.router.Get(s.prefixPath("/agents/create-requests/{creation_request_id}"), s.handlers.agent.HandleGetAgentCreationRequest)
...
func (s *Server) mountCapabilityRoutes() {
	...
	s.router.Get(s.prefixPath("/custom-mcp-servers/{connector_id}"), s.handlers.connector.HandleGetCustomMCPServer)
	s.router.Put(s.prefixPath("/custom-mcp-servers/{connector_id}"), s.handlers.connector.HandleUpdateCustomMCPServer)
	s.router.Patch(s.prefixPath("/custom-mcp-servers/{connector_id}/enabled"), s.handlers.connector.HandleSetCustomMCPServerEnabled)
	s.router.Get(s.prefixPath("/custom-mcp-servers/{connector_id}/capabilities"), s.handlers.connector.HandleGetCustomMCPCapabilities)
	...
	s.router.Get(s.prefixPath("/capability/channels/{channel_type}/login"), s.handlers.channel.HandleGetCurrentChannelLogin)
	...
	s.router.Get(s.prefixPath("/capability/scheduled/tasks/create-requests/{request_id}"), s.handlers.automation.HandleGetScheduledTaskCreateRequest)
	...
	s.router.Post(s.prefixPath("/capability/scheduled/tasks/{job_id}/deletion/confirm-stopped"), s.handlers.automation.HandleConfirmScheduledTaskDeletionStopped)
	...
	s.router.Get(s.prefixPath("/scheduled/tasks/create-requests/{request_id}"), s.handlers.automation.HandleGetScheduledTaskCreateRequest)
	...
	s.router.Post(s.prefixPath("/scheduled/tasks/{job_id}/deletion/confirm-stopped"), s.handlers.automation.HandleConfirmScheduledTaskDeletionStopped)
