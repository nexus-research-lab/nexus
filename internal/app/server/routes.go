...
func (s *Server) mountRoomRoutes() {
	...
	s.router.Get(s.prefixPath("/rooms/{room_id}/conversations/{conversation_id}/memory/items"), s.handlers.room.HandleListConversationMemory)
	s.router.Post(s.prefixPath("/rooms/{room_id}/conversations/{conversation_id}/memory/items"), s.handlers.room.HandleAddConversationMemory)
	s.router.Patch(s.prefixPath("/rooms/{room_id}/conversations/{conversation_id}/memory/items/{entry_id}"), s.handlers.room.HandleUpdateConversationMemory)
	s.router.Delete(s.prefixPath("/rooms/{room_id}/conversations/{conversation_id}/memory/items/{entry_id}"), s.handlers.room.HandleDeleteConversationMemory)
	s.router.Get(s.prefixPath("/rooms/{room_id}/conversations/{conversation_id}/memory/stats"), s.handlers.room.HandleConversationMemoryStats)
	s.router.Get(s.prefixPath("/rooms/{room_id}/conversations/{conversation_id}/memory/members"), s.handlers.room.HandleListConversationMemberMemory)
