...
type executionCoordinator struct {
	goals      lifecycleService
	executions executionService
}

// NewExplicitExecutionCoordinator 创建 Goal 与 Execution 的显式绑定协调器。
func NewExplicitExecutionCoordinator(
	goals lifecycleService,
	executions executionService,
...
func (c *executionCoordinator) Create(
	ctx context.Context,
...
func (c *executionCoordinator) PrepareExplicitGoalBinding(
	ctx context.Context,
...
func (c *executionCoordinator) ResolveExplicitGoalActivation(
	ctx context.Context,
...
func (c *executionCoordinator) ConfirmGoalExecutionBinding(
	ctx context.Context,
...
func (c *executionCoordinator) Current(
	ctx context.Context,
	sessionKey string,
) (*protocol.Goal, error) {
...
func (c *executionCoordinator) CurrentOptional(
	ctx context.Context,
	sessionKey string,
) (*protocol.Goal, error) {
...
func (c *executionCoordinator) CurrentModelMutationAuthority(
	ctx context.Context,
	sessionKey string,
	ownerUserID string,
	agentID string,
...
func (c *executionCoordinator) RetargetByModel(
	ctx context.Context,
	sessionKey string,
...
func (c *executionCoordinator) AuditObjectiveAlignmentByModel(
	ctx context.Context,
	goalID string,
...
func (c *executionCoordinator) CompleteByModel(
	ctx context.Context,
	goalID string,
...
func (c *executionCoordinator) BlockByModel(
	ctx context.Context,
	goalID string,
