...
func TestSessionOwnershipRejectsCrossOwnerAgentAndRoomKeys(t *testing.T) {
	const (
		attacker = "owner-attacker"
		victim   = "owner-victim"
	)
	verifier := NewSessionOwnershipVerifier(
...
func TestSessionOwnershipReturnsOnlyServerVerifiedRoomMember(t *testing.T) {
	const owner = "owner-1"
	verifier := NewSessionOwnershipVerifier(
		ownerScopedGoalSessionAgentReader{agents: map[string]map[string]protocol.Agent{
			owner: {
...
func TestSessionOwnershipUsesPersistedAgentForAllAgentSessionShapes(t *testing.T) {
	const owner = "owner-1"
	verifier := NewSessionOwnershipVerifier(
		ownerScopedGoalSessionAgentReader{agents: map[string]map[string]protocol.Agent{
			owner: {
...
func TestSessionOwnershipApplicationGateRejectsVictimDMAndRoomWithoutSideEffects(t *testing.T) {
	const (
		attacker = "owner-attacker"
		victim   = "owner-victim"
	)
