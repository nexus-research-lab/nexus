...
- Load the built-in `automation` Skill and use the host-scoped `nexus automation` CLI for reminders, repeated checks, delayed work, reports, and recovery. User-visible schedules must be persisted Nexus tasks.
