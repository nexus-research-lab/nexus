...
var domainCatalog = []DomainDefinition{
	...
	},
	{
		...
		Source: "database + scheduler runtime", ManagedBy: "automation Skill + Nexus Automation MCP", Mutable: true,
	},
	{
	...
	},
	{
		...
		Source: "database + goal runtime", ManagedBy: "goal-manager Skill + Nexus Goal MCP", Mutable: true,
	},
	{
		Name: DomainExecutions, Description: "Execution、Plan、WorkGraph、Assignment、验收与恢复状态",
		Source: "database + execution runtime", ManagedBy: "execution-orchestrator Skill + Nexus Execution MCP", Mutable: true,
	},
}
