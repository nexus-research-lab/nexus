...
func TestEnsurePlatformSkillLibrarySyncsNXSAndClaudeEntrypoints(t *testing.T) {
	...
	for _, path := range []string{
		...
		filepath.Join(appfs.PlatformSkillRoot(), ".agents", "skills", "execution-orchestrator", "references", "workflow-reuse.md"),
		...
		filepath.Join(appfs.PlatformSkillRoot(), ".claude", "skills", "execution-orchestrator", "references", "workflow-reuse.md"),
