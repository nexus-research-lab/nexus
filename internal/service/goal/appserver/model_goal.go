// INPUT: Nexus Goal 状态与 Codex app-server Goal 参数。
// OUTPUT: 保留兼容 tokensUsed 且显式区分 actual/budget 的 ThreadGoal 模型。
// POS: Goal 领域与 Codex app-server v2 之间的协议投影。
package appserver
...
type ThreadGoal struct {
	...
	ActualTokensEstimated bool             `json:"actualTokensEstimated"`
