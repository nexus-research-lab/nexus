...
//   - metadata_editor.go：由 owner 的 Nexus 主智能体承载目录隐藏专用 DM，不继承源 transcript/权限；恢复已有编辑会话也先保留保存表单的元信息修改，通过 execution-orchestrator Skill + round-scoped CLI 对完整草图做版本化修改与应用。
//
