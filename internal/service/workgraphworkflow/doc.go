...
//
// 成员清单：
//   - builtins.go / methodology_builtins.go：系统内置的双语通用责任拓扑与第一性原理、MECE、系统思维、双钻、JTBD、商业模式、金字塔、OODA、本体论运营模板；每个模板带结构化产物契约，只进入目录、Slash catalog 与 runtime 展开，不写数据库或携带运行事实。
