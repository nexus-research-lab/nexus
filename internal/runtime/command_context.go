// INPUT: 当前 round 的 actor、scope、runtime lease、Connector 选择与可信 authority。
// OUTPUT: command/capability builder 共用且不可由模型输入覆盖的运行上下文。
// POS: runtime 内部 round-scoped 上下文的统一定义。
package runtime
