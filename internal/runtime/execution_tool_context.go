// INPUT: 当前 DM/Room round 的完整 actor、scope、permission、WorkBinding/ReviewBinding 与共享 Goal authority。
// OUTPUT: 保留 producer/reviewer trusted capability，并让 Execution MCP 动态读取 Goal identity 的专用构造上下文。
