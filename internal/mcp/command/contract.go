...
// OUTPUT: Goal、Execution 与 Automation 共用的 contract/inspect/invoke 请求及 transport-neutral operation result。
...
const (
	...
	GoalOperationCreate       = nexusmcp.GoalOperationCreate
	GoalOperationRetarget     = nexusmcp.GoalOperationRetarget
	GoalOperationAudit        = nexusmcp.GoalOperationAudit
	GoalOperationUpdate       = nexusmcp.GoalOperationUpdate
	ExecutionOperationPlan    = nexusmcp.ExecutionOperationPlan
	ExecutionOperationPromote = nexusmcp.ExecutionOperationPromote
)
