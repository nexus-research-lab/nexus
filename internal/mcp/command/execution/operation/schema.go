...
// OUTPUT: Plan 两阶段工具严格区分外层 Goal binding 与内层 document scalar，work/review 工具静态表达 binding 默认与 action=inspect 协调入口，其余工具保留有界集合；全部隐藏 identity/fencing/idempotency。
