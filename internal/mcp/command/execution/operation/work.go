...
func assignWork(svc contract.Service, sctx contract.Context) command.Operation {
...
func submitWork(svc contract.Service, sctx contract.Context) command.Operation {
...
func reviewWork(svc contract.Service, sctx contract.Context) command.Operation {
...
func blockWork(svc contract.Service, sctx contract.Context) command.Operation {
...
func resumeWork(svc contract.Service, sctx contract.Context) command.Operation {
...
func takeOverWork(svc contract.Service, sctx contract.Context) command.Operation {
...
) (*orchestrationSnapshot, string, *command.Result) {
