...
func mutationResult(result orchestration.MutationResult) command.Result {
...
func rejectedResult(message string, actions ...orchestration.NextAction) command.Result {
...
func recoverableMutationRejection(err error) (command.Result, bool) {
...
func transportErrorResult(err error) command.Result {
