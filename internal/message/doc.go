...
//   - tool_result.go / workspace_artifact.go：工具结果消息、观察、Goal 进展与工作区产物投影。
//   - segment_assistant.go / projection_result.go：assistant 分段、show_widget 字符串参数的增量投影、普通流式工具输入、保留执行身份的结果摘要，以及只公开已知耗时/actual token 的 Goal 完成收据挂载。
