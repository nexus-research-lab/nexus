...
//   - tool_result_message.go / workspace_artifact.go / nexus_resource_artifact.go：
//     工具结果消息、工作区产物与可点击 Nexus 资源卡片投影。
//   - segment_assistant.go / projection_result.go / tool_result.go：assistant 分段、保留执行身份的结果摘要挂载、工具结果观测。
