-- +goose Up
ALTER TABLE automation_task_runs ADD COLUMN delivery_attempt_id VARCHAR(64);
ALTER TABLE automation_task_runs ADD COLUMN delivery_attempt_started_at TIMESTAMP;
ALTER TABLE automation_scheduled_tasks ADD COLUMN last_completed_run_id VARCHAR(64);
...
CREATE INDEX idx_automation_task_runs_delivery_due
...
ALTER TABLE automation_scheduled_tasks DROP COLUMN last_completed_run_id;
ALTER TABLE automation_task_runs DROP COLUMN delivery_attempt_started_at;
ALTER TABLE automation_task_runs DROP COLUMN delivery_attempt_id;
