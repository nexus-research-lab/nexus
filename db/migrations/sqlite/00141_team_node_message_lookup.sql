...
UPDATE team_node_jobs SET source_room_id=COALESCE(json_extract(data_json, '$.Delivery.room_id'), ''),
 source_message_id=COALESCE(json_extract(data_json, '$.Delivery.message_id'), ''), delivery_id=COALESCE(json_extract(data_json, '$.Delivery.id'), '');
